...
public class sLinkedList<E> implements listContract<E>{
	...
	public class sLinkedListIter<E> implements Iterator<E>{
		
		sLinkedList<E>.sNode<E> current;
		...
		public E next() 
		{
			sLinkedList<E>.sNode<E> tmp = current;
	...
	@Override
	public sLinkedListIter<E> iterator() {
		// TODO Auto-generated method stub
		sLinkedListIter<E> iter = new sLinkedListIter<E>(this);
		return iter;
	}
	// ------------------------------------------------------
